import "./VerticalBarChartJsEsaProgress.css";
...
export default function VerticalBarChartJsEsaProgress(props) {
  useEffect(() => {}, []);
  const {
    title = "ความก้าวหน้า",
    ...
    items = [],
    labels = ["เขตพื้นที่ 1", "เขตพื้นที่ 2", "เขตพื้นที่ 3", "เขตพื้นที่ 4", "เขตพื้นที่ 5"],
    yText = "-- ความก้าวหน้า --",
    xText = "-- เขตพื้นที่ --",
    isLabelIcon = false,
    labelIconIndex = 0,
