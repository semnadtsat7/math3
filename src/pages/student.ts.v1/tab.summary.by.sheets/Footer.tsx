          ...
          >
...

            {
              ...
              <Column width={widths[3]} >
                ...
                <CellProgress
                  value={NumberUtil.percentage(metrics?.pass, metrics?.quiz || 0)}
                />
              </Column>
            }

            {
              ...
              <Column width={widths[4]} >
                <Typography>
                  <b>{NumberUtil.prettify(metrics.best || 0)}</b> <small style={{ opacity: 0.8 }}>/ {NumberUtil.prettify((metrics.quiz || 0) * 3)}</small>
                </Typography>
                <CellProgress
            ...
            }
            {
              ...
              <Column width={widths[5]} >
                <Typography>
                  <b>{NumberUtil.prettify(metrics.play || 0)}</b>
                </Typography>
              </Column>
            }
...

            {
              ...
              <Column width={widths[7]} >
                <Typography>
                  <b>{NumberUtil.prettify(metrics.hint || 0)}</b>
                </Typography>
              </Column>
            }
            
            {
              ...
              <Column width={widths[8]} >
                <Typography>
                  <b>{NumberUtil.prettify(metrics.help || 0)}</b>
                </Typography>
              </Column>
            }
