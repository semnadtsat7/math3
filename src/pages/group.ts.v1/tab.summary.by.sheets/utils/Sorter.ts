...
export function load ()
{
  ...
  const orderBy = ss.getItem('group-summary-by-sheets.orderBy') || 'order';
  const order = ss.getItem('group-summary-by-sheets.order') || 'asc';
...
export function set (orderBy: string, order: string)
{
  ...
  ss.setItem('group-summary-by-sheets.orderBy', orderBy);
  ss.setItem('group-summary-by-sheets.order', order);
}
