...
) =>
{
  ...
  const selected = useMemo(() => window.sessionStorage.getItem('group-summary-quiz-title.selected') || '', []);
  ...
  {
    window.sessionStorage.removeItem('group-summary-quiz-title.selected');
  }
    ...
    >
      ...
      <TableCell
        ...
        onClick={e => 
        {
          ...
          if (!!clickable)
          {
            window.sessionStorage.setItem('group-summary-quiz-title.selected', quiz.title);
            history.push(href)
          }
        }}
      >
