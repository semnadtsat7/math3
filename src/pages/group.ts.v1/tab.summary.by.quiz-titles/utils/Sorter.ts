...
export function load ()
{
  ...
  const orderBy = ss.getItem('group-summary-by-quiz-titles.orderBy') || 'order';
  const order = ss.getItem('group-summary-by-quiz-titles.order') || 'asc';
...
export function set (orderBy: string, order: string)
{
  ...
  ss.setItem('group-summary-by-quiz-titles.orderBy', orderBy);
  ss.setItem('group-summary-by-quiz-titles.order', order);
}
