...
import { Group, Sheet } from './listenStudents';
    ...
    <Footer>
...

      {
        ...
        <Dropdown 
          ...
          items={
            [
              { value: 'none', label: 'นักเรียนทุกคน' },
              { value: 'nogroup', label: 'นักเรียนที่ไม่ได้ระบุกลุ่มเรียน' },
            ].concat(
              groups.map(e => { return { value: e._id, label: 'นักเรียน ' + e.name } })
            )
          }
        />
      }
      ...
      {/* {
        ...
        <Field>
          ...
          <Select
            ...
            size="small"
            value={filter.groupID}
            onChange={(value: string) => handleChange('groupID', value)}
          >
