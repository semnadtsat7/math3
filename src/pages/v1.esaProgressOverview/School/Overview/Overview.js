...
export default function PageESAProgressOverview() {
  ...
  const onChosenDistricInspectorName = ({ key }) => {
    ...
    useEffect(() => {
      if (chosenESAData.loading !== true) {
        ...
        setTimeout(() => {
          if (typeof item !== 'undefined' && typeof item !== 'null' && item?.[0]?.length > 0) {
  ...
  const onChosenClassroomName3 = ({ key }) => {
    if (chosenSchoolData3.loading !== true) {
      const item = Object.values(chosenSchoolData3.schoolReport?.schoolInfo?.classes).filter((data) => {
        if (data?.name === key) return data;
      });
      console.log(item);
  ...
  const onClick = () => {
    ...
    //console.log(dataDistrictInspector);
  };
  ...
  useEffect(() => {
    if (dataDistrictInspector.loading !== true) {
      ...
      if (
        ...
        const item = Object.values(dataDistrictInspector?.[0]?.giReport?.[0]?.esaReport?.[0]
  ...
  useEffect(() => {
    if (chosenSchoolData3.loading !== true) {
      if (position === "R-2") {
        const item = Object.values(chosenSchoolData3.schoolReport?.schoolInfo?.classes);
        setChosenClassroomName3(item?.[0]?.name);
        setChosenClassroomData(item);
        setTimeout(() => {
          setBarChartStatisticsByClassroom2({ loading: false });
                  ...
                  <Row gutter={[8, 8]} type="flex">
                                ...
                                overlay={
                                  chosenESAData?.loading ? (
                                    ...
                                    <Menu onClick={onChosenSchoolName}>
                                      {chosenESAData?.esaReport?.map((key) => {
                                        return (
                                          <Menu.Item key={key?.name?.thai}>
                                            {key?.name?.thai}
                                          </Menu.Item>
                                        );
                                      })}
                        ...
                        <CardWithTitleNoIcon title={chosenESAName || ""}>
                          <VerticalBarChartJsSchoolProgress
                            ...
                            labels={
                              chosenESAData?.loading
                                ? []
                                : chosenESAData?.esaReport?.map((item) => {
                            ...
                            items={
                              chosenESAData?.loading
                                ? []
                                : chosenESAData?.esaReport?.map((item) => {
                                    return item?.schoolReport?.schoolInfo
                                      ?.averageProgess;
                                  })
                            }
                            color={
                          ...
                          <VerticalBarChartJsClassroomProgress
                            ...
                            labels={
                              chosenSchoolData?.loading
                                ? []
                                : Object.values(
                                    chosenSchoolData?.schoolReport?.schoolInfo
                                      ?.classes
                                  ).map((item) => {
                                    return item?.name;
                                  })
                    ...
                    <Col span={24} offset={0}>
                      ...
                      <CardWithTitleNoIcon
                        title={
                          "ข้อมูลโรงเรียน" +
                          ((userSchoolName && userSchoolName?.name?.thai) ||
                            "") +
                      ...
                      >
                        <div>
                          ...
                          {(position === "R-5" ||
                            ...
                            <ProgressCard
                              title="เขตพื้นที่ทั้งหมด"
                              numberOfItems={
                                chosenDistrictInspectorData?.giReport?.length ||
                                0
                              }
                              unit="เขต"
                            />
                                  ...
                                  overlay={
                                    chosenESAData2?.loading ? (
                                      ...
                                      <Menu onClick={onChosenSchoolName2}>
                                        {Object.values(chosenESAData2)?.map((key) => {
                                          return (
                                            <Menu.Item key={key?.name?.thai}>
                                              {key?.name?.thai}
                                            </Menu.Item>
                                ...
                                {chosenSchoolData?.schoolReport?.teachersInfo?.map(
                                  (item) => (
                                    <TeacherCard
                                      ...
                                      homework={
                                        item?.stats?.numberOfHomeworkAssigned ||
                                        ""
                                      }
                                      time={item?.userInfo?.loginTime || ""}
                        ...
                        {position === "R-2" && (
                          <Tabs type="card" defaultActiveKey="1">
                            <TabPane tab="ข้อมูลครู" key="1">
                              <div>
                                {chosenSchoolData3?.schoolReport?.teachersInfo?.map((item) => (
                                  <TeacherCard
                                    prefix={item?.userInfo?.namePrefix || ""}
                                    firstName={item?.userInfo?.firstName || ""}
                                    lastName={item?.userInfo?.lastName || ""}
                                    classrooms={item?.stats?.numberOfClasses || ""}
                                    progess={item?.stats?.averageProgess || ""}
                                    homework={item?.stats?.numberOfHomeworkAssigned || ""}
                                      ...
                                      >
                                        ...
                                        >
                                          <DropdownFormNoTitle
                                            ...
                                            md={8}
                                            lg={7}
                                            loading={chosenSchoolData3?.loading}
                                            overlay={
                                              chosenSchoolData3?.loading ? (
                                                ...
                                                >
                                                  {Object.values(chosenSchoolData3?.schoolReport?.schoolInfo?.classes)?.map(
                                                    (key) => {
                                                      return (
                                                        <Menu.Item
                                                          key={key.name}
                                      ...
                                      >
                                        ...
                                        >
                                          <DropdownFormNoTitle
                                            ...
                                            md={8}
                                            lg={7}
                                            loading={chosenSchoolData2?.loading}
                                            overlay={
