...
const Comp: React.FC = () =>
{
  ...
  const { view, filter, sort, setFilter, setSort } = listenGroups(spaceIDs);
  ...
  return (
    <Parent ref={parent} >
      ...
      <Header
        ...
        title={
          <>
            โรงเรียน{schools?.name?.thai} - กลุ่มเรียนทั้งหมด
            {
              view.fetching !== 'full' &&
              <span style={{ marginLeft: 4 }} >
                ({view.metrics.group} ห้อง)
              </span>
            }
            {
